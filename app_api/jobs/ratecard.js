module.exports.getRateCardList = function () {
    ...
    var options = {
        method: 'GET',
        url: 'https://management.azure.com/subscriptions/' + global.subscriptionId + '/providers/Microsoft.Commerce/RateCard',
        qs: {
    ...
    request(options, function (error, response, body) {
        if (error) {
            ...
            for (var i = 0; i < metersArr.length; i++) {
                RC.update(
                    {subscriptionId: global.subscriptionId, MeterId: metersArr[i].MeterId},
                    {
            ...
            winston.log('info', '[RateCard] RateCard for subscription is updated');
        }
    });
};